      	...
      	<div class="container">
          	<div class="row">
              	<div class="col-md-6 col-sm-12 ">
                  	...
                  	<div id="theme">
                      	<p>My </p>
                          <h4 class="wow fadeInDown" data-wow-duration="0.3s"><span class="h4-style">Trust ID</span></h4>
                      </div>
      									...
      									<div class="tabbable-line">
      										...
      										<div class="tab-content">
      											<div class="tab-pane active" id="tab_default_1">
      												...
      												<img src="./images/icon.gif"><a href="https://www.msctrustgate.com/mytrustid">Get your MyTrust ID</a>
