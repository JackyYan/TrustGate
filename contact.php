	...
	<div class="container">
    	<div class="row">
        	<div class="col-md-6 col-sm-12 ">
            	...
            	<div id="theme">
                	<p>Contact </p>
                    <h4 class="wow fadeInDown" data-wow-duration="0.3s"><span class="h4-style">Us</span></h4>
                </div>
...
<!-- Map -->
<div class="map-container wow fadeIn" data-wow-duration="1s">
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCbEfFgNr-UI3U_493_jJJDKpo92l3eJQc&callback=initMap"></script>
